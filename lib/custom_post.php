...
function pg_create_post_type() {
	...
	register_post_type ( "$custom_post_type", array (
			...
			'query_var' => "$custom_post_type", // This goes to the WP_Query
			                                      // schema
			'supports' => array (
					'title',
					// 'author',
	...
	register_taxonomy ( "$custom_cat_type", array (
			"$custom_post_type" 
	), array (
			"hierarchical" => false,
			"label" => CUSTOM_MENU_CAT_LABEL,
			'labels' => array (
					'name' => CUSTOM_MENU_CAT_TITLE,
	...
	register_taxonomy ( "$custom_tag_type", array (
			"$custom_post_type" 
	), array (
			"hierarchical" => false,
			"label" => CUSTOM_MENU_TAG_LABEL,
			'labels' => array (
					'name' => CUSTOM_MENU_TAG_TITLE,
